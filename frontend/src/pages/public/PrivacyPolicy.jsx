...
const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'p', text: "Our AI booking assistant is powered by OpenAI's GPT models. Conversation data from the booking chat may be processed by OpenAI to generate responses. We do not send personally identifiable information to OpenAI beyond what is necessary for booking assistance." },
