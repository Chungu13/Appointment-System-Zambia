...
function ServiceCard({ data, onSend }) {
  return (
    <div style={{ backgroundColor: 'rgba(255,255,255,0.04)', border: '0.5px solid rgba(255,255,255,0.1)', borderRadius: 10, padding: 14, marginTop: 4 }}>
      <p style={{ fontFamily: serif, fontSize: 17, fontWeight: 400, color: '#fff', margin: '0 0 4px', lineHeight: 1.2 }}>
        {data.name}
      </p>
      <p style={{ fontFamily: sans, fontSize: 11, fontWeight: 300, color: 'rgba(255,255,255,0.5)', margin: '0 0 8px' }}>
      ...
      <p style={{ fontFamily: sans, fontSize: 18, fontWeight: 400, color: '#fff', margin: '0 0 12px', lineHeight: 1 }}>
        ZMW {data.price}
        {data.deposit && (
          <span style={{ fontSize: 12, fontWeight: 300, color: 'rgba(255,255,255,0.45)', marginLeft: 8 }}>
      ...
      <button
        ...
        style={{ width: '100%', padding: '9px 0', backgroundColor: PRIMARY, color: '#fff', border: 'none', borderRadius: 6, fontFamily: sans, fontSize: 12, fontWeight: 500, letterSpacing: '0.04em', cursor: 'pointer' }}
      >
        Select a time
      </button>
    </div>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
        {data.slots.map((slot) => (
          <button
            ...
            style={{
              padding: '6px 12px',
              backgroundColor: selected === slot ? PRIMARY : 'rgba(255,255,255,0.06)',
  ...
  return (
    <form onSubmit={submit} style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 12px', borderTop: '0.5px solid rgba(255,255,255,0.08)', flexShrink: 0 }}>
      <input
        ...
        style={{ flex: 1, backgroundColor: 'rgba(255,255,255,0.06)', border: '0.5px solid rgba(255,255,255,0.1)', borderRadius: 10, padding: '9px 14px', fontFamily: sans, fontSize: 13, fontWeight: 300, color: '#fff', outline: 'none' }}
      />
      <button
        type="submit"
