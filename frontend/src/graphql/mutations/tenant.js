...
export const UPDATE_TENANT_PROFILE = gql`
  mutation UpdateTenantProfile($coverImageUrl: String, $address: String, $phone: String, $city: String, $area: String) {
    updateTenantProfile(coverImageUrl: $coverImageUrl, address: $address, phone: $phone, city: $city, area: $area)
  }
`
