...
"No further questions. Go straight to Step 3.\n\n"
        ...
        "When check_availability returns no slots, it includes a 'reason' field — use it:\n"
        "  reason=closed       → 'We're closed on [day name].'\n"
        "  reason=past_closing → 'We're done for the day — our last slot has passed.'\n"
        "  reason=fully_booked → 'We're fully booked on [day name].'\n"
        f"If today has no slots, automatically check tomorrow ({tomorrow.isoformat()}) and explain today's reason first.\n"
