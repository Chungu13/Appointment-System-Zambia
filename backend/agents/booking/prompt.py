...
def build_system_prompt(tenant, customer_name: str = "") -> str:
    ...
    return (
        ...
        "  → If available_staff has 2 or more entries: assign the best staff member, then you MUST "
        "send this message BEFORE the booking summary — do NOT skip it: "
        "'I've paired you with [staff name]! If you'd prefer a different stylist, just let me know — "
        "otherwise I'll go ahead and confirm your booking.' "
        "Then WAIT for the customer to either approve or name someone else before proceeding.\n"
        ...
        "  Validate FORMAT — accept any of these three formats ONLY:\n"
        ...
        "  Validate NETWORK PREFIX — strip the country code and leading zero, then check the first 2 digits:\n"
        "    MTN: 76 or 96 | Airtel: 57, 77, or 97 | Zamtel: 95\n"
        "    Examples of valid numbers: 0761234567, 0961234567, 0571234567, 0951234567\n"
        "  If format is wrong OR prefix is not in the list above: ask once more —\n"
        "    'That doesn't look like a valid Zambian mobile money number. Please enter a valid MTN, Airtel, or Zamtel number.'\n"
