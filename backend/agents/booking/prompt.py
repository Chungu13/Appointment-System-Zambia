...
"  If the tool returns valid=false on first attempt:\n"
...
"    Wait for their reply, then call validate_phone_number again.\n\n"
"  If the tool returns valid=false on second attempt:\n"
